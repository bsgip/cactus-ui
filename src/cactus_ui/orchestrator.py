...
def create_compliance_request(
    ...
    response = safe_request(
        ...
        json=orchestrator.ComplianceRequestRequest(
            ...
            der_cec_listed_models=der_cec_listed_models,
            der_unlisted_models=der_unlisted_models,
            der_white_listed_models=der_white_listed_models,
